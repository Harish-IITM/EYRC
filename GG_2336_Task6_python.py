...
"""
* Team Id : GG_2336
* Author List : Ajan M, Harish K N, Dhiraj J, Santhosh 
* Filename: final_sample
* Theme: GeoGuide

* Functions: read_csv(csv_name), read_csv_1(csv_name), tracker(ar_id , lat_lon), nearest_aruco(image), signal_handler(sig,frame), cleanup(),
dijkstra(graph,start,end), main(pos,bot_center), direc_event_path(cmd,pth,loops_run), event_node(dict_with_pref,ko), detect_ArUco_details(image),
detect_ArUco_center(image,aruco_id), present_node(centre_coordinates), bot_dir(marker_corners), alg_call(possible_paths,dir), best_path(bot_center,dir), 

* Global Variables: ko, end_node_list, enlst
*
"""
...
*Logic: reads the priority order csv file in form of dictionary
*Example Call: lat_lon = read_csv('lat_long.csv')
"""
...
"""
*Function Name: read_csv_1
*Input: csv_name
*Output: lat_lon
*Logic: reads the latitudes and longitudes csv file in form of dictionary
*Example Call: lat_lon = read_csv_1('lat_long.csv')
"""
...
*Input: ar_id , lat_lon
*Output: coordinate
*Logic: live data that will be used to updation in qgis 
*Example Call: tracker ( k , lat_lon )
"""
...
"""
*Function Name: nearest_aruco
*Input: image
*Output: ar_id
*Logic: used to find the nearest aruco using eulers formula
*Example Call: k = nearest_aruco ( transformed_image )
"""
...
*Logic: weights are distributed to neighbor, path and heap with the djkstra logic 
*Example Call: shortest_path = dijkstra ( graph , start_node , end_node_list[pos] )
"""
...
"""
*Function Name: main
*Input: pos , bot_center
*Output: paths
*Logic: Returns the possible paths that can be followed by assigning names to each nodes and using dijkistra algorithm
*Example Call: possible_path_2 = main ( 1 , bot_center )
"""
...
"""
*Function Name: direc_event_path
*Input: cmd , pth , loops_run
*Output: cmd
*Logic: used to append the last element of the cmd list that is used for arduino to read and take turns accordingly
*Example Call: updated_cmd = direc_event_path ( cmd_list[0] , pth_list[0] , loops_run )
"""
...
"""
*Function Name: event_node
*Input: dict_with_pref , ko
*Output: end_node , ko
*Logic: the endnode of the input of algorithm is decided here
*Example Call: ko = event_node ( dict_with_pref , ko )
"""
...
*Logic: Sends the aruco corners
*Example Call: ArUco_corners = detect_ArUco_details ( transformed_image )
"""
...
"""
*Function Name: detect_ArUco_details_1
*Input: image
*Output: ArUco_details_dict , ArUco_corners
*Logic: returns information of the aruco markes (we have sued this in task 2)
*Example Call: ArUco_corners1 = detect_ArUco_details_1 ( transformed_image )
"""
...
"""
*Function Name: detect_ArUco_center
*Input: image , aruco_id
*Output: center_coordinates
*Logic: used to get center coordinates of the aruco from inbuilt function
*Example Call: centre = detect_ArUco_center ( transformed_image , 100 )
"""
...
"""
*Function Name: present_node
*Input: centre_coordinates
*Output: node
*Logic: from cam,era feed, we will get the to know on which node the bot is standing
*Example Call: node=present_node(centre)
"""
...
"""
*Function Name: bot_dir
*Input: marker_corners
*Output: It returns directions
*Logic: returns the direction using the camera feed
*Example Call: dir = bot_dir ( ArUco_corners1[100] )
"""
...
"""
*Function Name: alg_call
*Input: possible_paths , dir
*Output: cmd , pth , penalty[a]
*Logic: gets the possible paths of the and returns the penalty of each paths taken by using the algorithm
*Example Call: cmd , pth , pty = alg_call ( vk , dir )
"""
...
"""
*Function Name: best_path
*Input: bot_center , dir
*Output: The conditional statements used gives the following outputs: 
*Logic: compiles all the possible paths and takes the least penalty path and updates the final command path
*Example Call: cmd , pth = best_path ( bot_center , dir )
"""
